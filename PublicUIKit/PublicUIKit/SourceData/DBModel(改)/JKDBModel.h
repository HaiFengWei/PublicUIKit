...
#pragma mark 添加注释by radish。 更新JKDB第三方，注意保留
/** SQLite五种数据类型 */
...
// 现支持对象类型类型：NSMutableArray、NSArray、NSMutableDictionary、NSDictionary、CLLocation、NSString
...
/** 模型对应的属性 array --> T@*/
@property (nonatomic, strong) NSArray <NSString *>* attributesArray;
